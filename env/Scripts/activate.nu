...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\GOTNI\Documents\Python\DjangoURLs-2\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\GOTNI\Documents\Python\DjangoURLs-2\env\Scripts\deactivate.nu'
